            ...
            <div className=' border-white border w-full px-[20px] pt-[20px]'>
                <div className='grid grid-cols-12 gap-3 h-[62px] text-white '>
                    ...
                    <div className='col-span-3 '>
                        <select defaultValue='anycategory' className='w-full h-[38px] py-[7px] px-[16px] border border-white outline-none bg-transparent rounded-sm'>
                    ...
                    <div className='col-span-1 h-[38px] rounded-md px-[12px] py-[6px] bg-transparent border border-white cursor-pointer'>
                        <button className='text-white hover:opacity-80' >Search</button>
                    </div>
                </div>
