...
function SearchForm({ getSearchData }) {
    ...
    const searchHandle = async () => {
        try {
            const fetchData = fetch('https://scm-tool.thanhpp.ninja/storage')
            ...
            <div className=' border-white border w-full px-[20px] pt-[20px]'>
                <div className='grid grid-cols-12 gap-3 h-[62px] text-white '>
                    <div className=' col-span-11 '>
                        <input onChange={inputHnadle} className='w-full border border-white h-[38px] py-[7px] px-[16px] outline-none bg-transparent text-white placeholder-white ' placeholder='Search keywords' type='text' />
                    </div>
