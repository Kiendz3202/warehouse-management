            ...
            <div className=' border-white border w-full px-[20px] pt-[20px]'>
                <div className='grid grid-cols-12 gap-3 h-[62px] text-white '>
                    <div className=' col-span-5 '>
                        <input className='w-full border border-white h-[38px] py-[7px] px-[16px] outline-none bg-blue-400 text-white placeholder-white ' placeholder='Search keywords' type='text' />
                    </div>
