...
function ItemWarehouse() {
    ...
    return (
        <div className=' grid grid-cols-12 gap-3 text-black  border-black border-t'>
            ...
            <div className=' col-span-3 my-auto cursor-pointer  truncate'>name</div>
            ...
            <div className=' col-span-1 my-auto cursor-pointer  truncate'>vendor</div>
            <div className=' col-span-2 my-auto pl-[5px] flex justify-between truncate'>
                <span>arrivalDate</span>
                <span className=' border-l border-dotted'></span>
                <span className=' mr-[10px] rounded-sm cursor-pointer'><Delete className='' /></span>
            </div>
        </div>
    )
}
