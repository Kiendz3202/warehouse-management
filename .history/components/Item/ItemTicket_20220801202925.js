...
function ItemTicket({ id, supplierId, storageId, status, fee, billImage, productImage, receiveTime, sendTime }) {
            ...
            <Modal show={showModal} onClose={() => setShowModal(false)}>
                <div>
                    <div className='flex mb-[26px]'>
                        ...
                        <input id='id' onChange={idHandle} type='text' defaultValue={id} readOnly className='text-black h-[38px] w-[380px] pl-[15px] pr-[40px]' />
                    </div>
                    <div className='flex mb-[26px]'>
                        <div className='flex justify-end w-[175px] leading-[38px] mr-[20px]'>
                            <label htmlFor='supplierId'>supplier id<span className='text-[#d13143]'>*</span></label>
                        </div>
                    ...
                    <div className='flex mb-[26px]'>
                        <div className='flex justify-end w-[175px] leading-[38px] mr-[20px]'>
                            <label htmlFor='storageId'>storage id<span className='text-[#d13143]'>*</span></label>
                        </div>
                    ...
                    <div className='flex mb-[26px]'>
                        <div className='flex justify-end w-[175px] leading-[38px] mr-[20px]'>
                            <label htmlFor='status'>status<span className='text-[#d13143]'>*</span></label>
                        </div>
                    ...
                    <div className='flex mb-[26px]'>
                        <div className='flex justify-end w-[175px] leading-[38px] mr-[20px]'>
                            <label htmlFor='fee'>fee<span className='text-[#d13143]'>*</span></label>
                        </div>
                        <input id='fee' onChange={feeHandle} value={feeUpdate} type='text' className='text-black h-[38px] w-[380px] pl-[15px] pr-[40px] truncate' />
                    </div>
                    <div className='flex mb-[26px]'>
                        <div className='flex justify-end w-[175px] leading-[38px] mr-[20px]'>
                            <label htmlFor='billImage'>bill image<span className='text-[#d13143]'>*</span></label>
                        </div>
                    ...
                    <div className='flex mb-[26px]'>
                        <div className='flex justify-end w-[175px] leading-[38px] mr-[20px]'>
                            <label htmlFor='productImage'>product image<span className='text-[#d13143]'>*</span></label>
                        </div>
                    ...
                    <div className='flex mb-[26px]'>
                        <div className='flex justify-end w-[175px] leading-[38px] mr-[20px]'>
                            <label htmlFor='receiveTime'>receive time<span className='text-[#d13143]'>*</span></label>
                        </div>
                    ...
                    <div className='flex mb-[26px]'>
                        <div className='flex justify-end w-[175px] leading-[38px] mr-[20px]'>
                            <label htmlFor='sendTime'>send time<span className='text-[#d13143]'>*</span></label>
                        </div>
