...
function ItemWarehouseProduct() {
    return (
        <div className=' grid grid-cols-12 gap-3 text-black  border-black border-t'>
            ...
            <Link href='/warehouse-management/hanoi-soc/product/id'><div className=' col-span-3 my-auto hover:border-b border-black cursor-pointer  truncate'>Kho Hà Nội Soc</div></Link>
