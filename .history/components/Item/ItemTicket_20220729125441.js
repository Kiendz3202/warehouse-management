...
function ItemTicket({ id, name, desc }) {
    ...
    return (
        <div className=' grid grid-cols-12 gap-3 text-black  border-black border-t'>
            ...
            <Link href={`/io-management/ticket/${id}`}><div className=' col-span-5 my-auto hover:border-b border-black cursor-pointer  truncate'>{name}</div></Link>
