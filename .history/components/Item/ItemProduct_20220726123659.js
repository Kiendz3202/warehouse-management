...
function ItemProduct({ sku, name, desc, itemTypeId, images }) {
    ...
    const [imageUpdate, setImageUpdate] = useState(images[0])
    ...
    const updateHandle = async () => {
        ...
        dataForm.append('images', imageUpdate)
            ...
            <Modal show={showModal} onClose={() => setShowModal(false)}>
                <div>
                    ...
                    <div className='flex mb-[26px]'>
                        ...
                        <input id='image' type='file' value={imageUpdate} onChange={imageHandle} className='text-black h-[38px] w-[380px] pl-[15px] pr-[40px] truncate' />
                    </div>
                </div>
                <div className='flex '>
