...
function ItemProduct({ sku, name, desc, itemTypeId, images }) {
    ...
    const [imagesUpdate, setImagesUpdate] = useState(images)
    ...
    const imageHandle = (e) => {
        setImageUpdate(e.target.value[0])
    }
    ...
    const updateHandle = async () => {
        ...
        dataForm.append('name', nameUpdate)
        dataForm.append('desc', descUpdate)
        dataForm.append('item_type_id', itemTypeIdUpdate)
        dataForm.append('images', imagesUpdate)
    ...
    return (
        <div className=' grid grid-cols-12 gap-3 text-black  border-black border-t'>
            ...
            <div className=' col-span-2 my-auto truncate'>location test</div>
            ...
            <Modal show={showModal} onClose={() => setShowModal(false)}>
                <div>
                    <div className='flex mb-[26px]'>
                        ...
                        <input id='sku' onChange={skuHandle} type='text' value={skuUpdate} className='text-black h-[38px] w-[380px] pl-[15px] pr-[40px]' />
                    </div>
                    <div className='flex mb-[26px]'>
                        <div className='flex justify-end w-[175px] leading-[38px] mr-[20px]'>
                    ...
                    <div className='flex mb-[26px]'>
                        ...
                        <input id='image' type='file' value={imagesUpdate} onChange={imageHandle} className='text-black h-[38px] w-[380px] pl-[15px] pr-[40px] truncate' />
                    </div>
                </div>
                <div className='flex '>
