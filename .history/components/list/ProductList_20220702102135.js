...
function ProductList() {
    ...
    return (
        ...
        <div className='bg-white rounded-md'>
            ...
            {productsData.map(product => <ItemProduct id={product.sku} sku={product.sku} key={product.sku} name={product.name} itemTypeId={product.item_type_id} desc={product.desc} />)}
            {/* <CircularProgress /> */}
            {/* </Box>} */}
