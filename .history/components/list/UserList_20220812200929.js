...
function UserList() {
    ...
    return (
        ...
        <div className='bg-white rounded-md'>
            ...
            {warehouseList && warehouseList.map(warehouse => <ItemUser id={warehouse.id} key={warehouse.id} name={warehouse.name} desc={warehouse.desc} location={warehouse.location} />)}
            {/* <CircularProgress /> */}
            {/* </Box>} */}
