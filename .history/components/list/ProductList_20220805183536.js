    ...
    useEffect(() => {
        const fetchProduct = async () => {
            try {
                ...
                const productDisplay = !isSearchingSelector ? data.data.slice(pagination.offset, parseInt(pagination.offset) + parseInt(pagination.numberPerPage)) : warehouseSelector.slice(pagination.offset, parseInt(pagination.offset) + parseInt(pagination.numberPerPage))

                setWarehouseList(productDisplay)
