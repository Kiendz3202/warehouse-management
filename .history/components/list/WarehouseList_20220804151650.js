    ...
    useEffect(() => {
        const fetchWarehouse = async () => {
            try {
                ...
                warehousesDisplay = !isSearchingSelector ? data.data.slice(pagination.offset, parseInt(pagination.offset) + parseInt(pagination.numberPerPage)) : warehouseSelector.slice(pagination.offset, parseInt(pagination.offset)) + parseInt(pagination.numberPerPage)
