...
function WarehouseList() {
    ...
    useEffect(() => {
        const fetchWarehouse = async () => {
            try {
                ...
                if (!isSearching) {
                    ...
                    const warehousesDisplay = data.data.slice(pagination.offset, parseInt(pagination.offset) + parseInt(pagination.numberPerPage))
                    ...
                    const warehouseList = warehouseSelector.slice(pagination.offset, parseInt(pagination.offset)) + parseInt(pagination.numberPerPage)
        ...
        fetchWarehouse()
    }, [pagination.offset, pagination.numberPerPage, pagination.pageCount])
