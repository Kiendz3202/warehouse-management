    ...
    return (
        ...
        <div className='bg-white'>
            <div className='grid grid-cols-12 gap-3 text-black'>
                ...
                <div className='flex justify-end my-auto col-span-1'><span onClick={removeHandle} className='mr-[12px] rounded-sm cursor-pointer '><Delete className=' hover:opacity-80' /></span></div>
            </div>
