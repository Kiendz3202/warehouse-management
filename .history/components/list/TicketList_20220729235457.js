...
function TicketList() {
    ...
    return (
        ...
        <div className='bg-white rounded-md'>
            ...
            {ticket && ticket.map(ticket => <ItemTicket id={ticket.id} key={ticket.id} supplierId={ticket.from_supplier_id} storageId={ticket.to_storage_id} status={ticket.status} fee={ticket.fee} />)}
            {/* <CircularProgress /> */}
            {/* </Box>} */}
