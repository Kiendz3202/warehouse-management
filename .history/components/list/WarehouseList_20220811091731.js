        ...
        const fetchWarehouse = async () => {
            ...
            try {
                const response = await fetch(`https://scm-tool.thanhpp.ninja/storage`, {
                    headers: {
                        'Authorization': `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE2NjAyNjkzOTEsImlhdCI6MTY2MDE4Mjk5MSwiaXNzIjoic2Ntc3J2IiwidXNlciI6eyJpZCI6NCwibmFtZSI6ImtpZW4iLCJ1c2VybmFtZSI6ImtpZW4ifX0.VRZnF4qgMlRnctdK0L8Ld2fUlmQ_dNXjfCR0CBaRIec`
                    }
                })
                if (!response) {
