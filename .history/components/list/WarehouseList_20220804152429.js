    ...
    useEffect(() => {
        const fetchWarehouse = async () => {
            try {
                ...
                // setWarehouseList(warehousesDisplay)
                // }
                console.log(typeof warehouseSelector)
                console.log(isSearchingSelector)
                console.log(warehouseSelector.slice(pagination.offset, parseInt(pagination.offset)) + parseInt(pagination.numberPerPage))
