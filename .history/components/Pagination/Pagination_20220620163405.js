    ...
    return (
        <div className='flex bg-white  h-[74px] p-[20px] border-t border-black'>
            <ReactPaginate
                ...
                previousLinkClassName={' py-2 px-3 leading-tight text-gray-500 bg-white rounded-r-lg border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-blue-500 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white'}
            ...
            <div className='ml-[5px] '>
                <select onClick={getValueHandle} defaultValue='25' className='bg-blue-500 outline-none text-white rounded-md'>
