            ...
            <div className='my-[32px]'>
                <div>
                    ...
                    <div className='flex mb-[26px]'>
                        ...
                        <input id='image' type='file' accept='image/png' value={productDetail?.images[0]} onChange={imageHandle} className='text-black h-[38px] w-[380px] pl-[15px] pr-[40px] truncate' />
                    </div>
                    <div className='flex mb-[26px]'>
