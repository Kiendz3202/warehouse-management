...
function ProductId() {
    ...
    const updateProductHandle = async () => {
        ...
        dataForm.append('new_images', productDetail.image)
        if (imageDelete) {
            ...
            <div className='my-[32px]'>
                <div>
                    <div className='flex mb-[26px]'>
                        ...
                        <input id='sku' type='text' disabled='true' defaultValue={productDetail?.sku ?? ''} className='text-black h-[38px] w-[380px] pl-[15px] pr-[40px]' />
                    </div>
                    <div className='flex mb-[26px]'>
                        <div className='flex justify-end w-[175px] leading-[38px] mr-[20px]'>
