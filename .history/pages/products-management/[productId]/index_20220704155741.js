...
function ProductId() {
    ...
    const productDetailData = useSelector((state) => state.products.productDetail)
    ...
    const fetchProduct = async () => {
        ...
        try {
            ...
            dispatch(productsSliceActions.saveProductDetail({
                data: item
            }))
            console.log(item)
    ...
    useEffect(() => {
        ...
        fetchProduct()
    }, [router.isReady, productDetailData])
        ...
        <div className='bg-blue-500 w-full h-full min-h-screen   p-[36px]'>
            <div>
                ...
                <div className=' text-[28px]'>
                    {productDetailData.name + 'can not display name product'}
                </div>
            </div>
