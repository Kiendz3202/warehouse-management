...
export default function Home() {
  return (
    <div >
      ...
      <div className='max-w-[250px] w-full mx-auto mt-[50px] '>
        <div>
          <div className=' text-center  p-[20px]'>Dành cho khách hàng</div>
          <div className=' text-center  p-[20px]'>Quét mã sản phẩm</div>
        </div>
      </div>
    </div>
  )
