        ...
        <div className='bg-blue-500 w-full h-full min-h-screen   p-[36px]'>
            ...
            <div className='text-white '>
                ...
                <div className='mb-[24px]'>
                    ...
                    <button onClick={() => router.push(`/io-management/ticket/generalSerial`)} className='text-[15px] mb-3 block bg-transparent hover:opacity-80 border border-white cursor-pointer rounded-md min-w-[110px] h-[34px] px-[12px] py-[6px]'>General serials</button>
                </div>
            </div>
            <div>
                <TicketList />
