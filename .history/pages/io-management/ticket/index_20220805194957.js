    ...
    const searchHandle = async () => {
        try {
            ...
            const dataSearched = data.data.filter((ticket) => {
                if (ticket.from_supplier_id.toString().includes(searchInput) || ticket.to_storage_id.toString().includes(searchInput) || ticket.fee.toString().includes(searchInput) || ticket.receive_time.toString().includes(searchInput) || ticket.send_time.toString().includes(searchInput)) {
                    return true
                }
                return false
            })
