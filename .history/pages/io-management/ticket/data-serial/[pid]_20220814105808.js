        ...
        <div>
            {data && auth && <table className=' w-full border-collapse border border-black'>
                <tbody>
                    ...
                    <tr>
                        <th className='border border-black' rowSpan={`${data.sku1.length + 1}`}>{'sku1'}</th>
                        {/* <td className='border border-black'>{'token id: '}</td> */}
                    </tr>
                    {/* <tr>
                        <td className='border border-black'>{'seri: '}</td>
                    </tr>
                    <tr>
                        <td className='border border-black'>{'seri: '}</td>
                    </tr>
                    <tr>
                        <td className='border border-black'>{'tx hash: '}</td>
                    </tr>
                    <tr>
                        <td className='border border-black'>{'ipfs cid: '}</td>
                    </tr> */}
                    {data.sku1.map((item) => (
                        <tr>
