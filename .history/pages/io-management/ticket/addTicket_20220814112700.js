...
function AddTicket() {
    ...
    const [numberAddItem, setNumberAddItem] = useState(0)
        ...
        <div className='bg-blue-500 w-full h-full min-h-screen   p-[36px]'>
            ...
            <div className='my-[32px]'>
                <div>
                    ...
                    <div className='flex mb-[26px]'>
                        <div className='flex justify-end w-[175px] leading-[38px] ml-[87px]'>
                            <div className=' border-white border  border-dashed rounded-sm cursor-pointer'>Add item</div>
                        </div>
                    </div>
                    {/* <div className='flex mb-[26px]'>
                        <div className='flex justify-end w-[175px] leading-[38px] mr-[20px]'>
