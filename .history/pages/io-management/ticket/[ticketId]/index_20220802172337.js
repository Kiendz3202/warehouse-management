...
function TicketId() {
    ...
    const [storageIdUpdate, setStorageIdUpdate] = useState()
    const [statusUpdate, setStatusUpdate] = useState()
    const [feeUpdate, setFeeUpdate] = useState()
    const [billImageUpdate, setBillImageUpdate] = useState()
    const [productImageUpdate, setProductImageUpdate] = useState()
    const [receiveTimeUpdate, setReceiveTimeUpdate] = useState()
