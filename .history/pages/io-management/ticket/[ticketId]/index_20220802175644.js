...
function TicketId() {
    ...
    const fetchTicket = async () => {
        ...
        try {
            ...
            setBillImageDisplay(ticketData.bill_image_paths[0])
            setProductImageDisplay(ticketData.product_image_paths[0])
            ...
            <div className='my-[32px]'>
                <div>
                    ...
                    <div className='flex mb-[26px]'>
                        ...
                        <div>
                            <div className=' max-h-full max-w-[500px]'><img src={billImageDisplay && billImageDisplay[0]} /></div>
                    ...
                    <div className='flex mb-[26px]'>
                        ...
                        <div>
                            <div className=' max-h-full max-w-[500px]'><img src={productImageDisplay && productImageDisplay[0]} /></div>
