                ...
                <div>
                    ...
                    <div className='flex mb-[26px]'>
                        ...
                        <div>
                            ...
                            <div><input id='billImage' onChange={billImageHandle} value={billImage} type='text' className='text-black h-[38px] w-[380px] pl-[15px] pr-[40px] truncate' /></div>
                        </div>
                    </div>
                    <div className='flex mb-[26px]'>
                        <div className='flex justify-end w-[175px] leading-[38px] mr-[20px]'>
                        ...
                        <input id='productImage' onChange={productImageHandle} value={productImage} type='text' className='text-black h-[38px] w-[380px] pl-[15px] pr-[40px] truncate' />
                    </div>
                    <div className='flex mb-[26px]'>
                        <div className='flex justify-end w-[175px] leading-[38px] mr-[20px]'>
