            ...
            <div className='my-[32px]'>
                <div>
                    ...
                    <div className='flex mb-[26px]'>
                        ...
                        <div>
                            <div className=' max-h-full max-w-[500px]'><img src={billImageDisplay && billImageDisplay} /></div>
                    ...
                    <div className='flex mb-[26px]'>
                        ...
                        <div>
                            <div className=' max-h-full max-w-[500px]'><img src={productImageDisplay && productImageDisplay} /></div>
