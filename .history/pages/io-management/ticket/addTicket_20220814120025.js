                ...
                <div>
                    ...
                    {numberAddItem && numberAddItem.map((item) => (
                        <div key={item.item_sku} className='flex mb-[26px]'>
                            <div onClick={addItemHandle} className='flex justify-end  leading-[38px] ml-[87px] cursor-pointer'>
                                <div className='border-white border border-collapse p-4 '>{'sku: ' + item.item_sku}</div>
                                <div className='border-white border border-collapse '>{'quantity: ' + item.buy_quantity}</div>
                                <div className='border-white border border-collapse '>{'price: ' + item.buy_price}</div>
                            </div>
                        </div>
                    ))}
                    {/* <div className='flex mb-[26px]'>
