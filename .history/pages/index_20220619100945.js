  ...
  return (
    <div className={styles.container}>
      ...
      <div className=' max-w-[410px] w-full m-auto border-2 mt-[200px]'>
        <form onSubmit={ } className='flex flex-col w-[380px] p-[15px] bg-[#f3f3f3] drop-shadow-md'>
          <p className=' text-center text-[#212509] text-[28px] my-[18px]'>Login</p>
          <div className=' justify-center mb-[5px] '>
            <input onChange={ } value={formValue.email} type="email" className='w-full p-[10px] border border-gray-600 outline-blue-300' placeholder='Email' />
            {/* {isValidated.email ?? <p>{isValidated.email}</p>} */}
          </div>
          <div className=' justify-center mb-[10px] '>
            <input onChange={ } value={ } type="password" className='w-full p-[10px] border border-gray-600 outline-blue-300' placeholder='Password' />
