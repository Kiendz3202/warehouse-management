      ...
      <div className=' max-w-[410px] w-full m-auto border-2 mt-[200px]'>
        <form onSubmit={(e) => {
          ...
          <div className=' justify-center mb-[5px] '>
            <input onChange={(e) => setFormValue({ ...formValue, email: e.target.value })} value={formValue.email} type="email" className='w-full p-[10px] border border-gray-600 outline-blue-300' placeholder='Email' />
        ...
        <div>Email:admin.training@powergatesoftware.com</div>
