...
function warehouseManagement() {
    return (
        //bg-[#1b1b38]
        <div className='bg-blue-400 w-full h-full min-h-screen   p-[36px]'>
            <div className='text-white '>
                ...
                <div className='mb-[24px]'>
                    <button className='text-[15px] block bg-transparent border border-white cursor-pointer rounded-md min-w-[110px] h-[34px] px-[12px] py-[6px] rounded-sm'>Add Products</button>
                </div>
            </div>
            <div>
                <WarehouseList />
